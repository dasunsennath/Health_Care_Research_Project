...
public class mealplan_input_heart extends AppCompatActivity {
    ...
    AutoCompleteTextView Gendertxt,Agetxt,Systolictxt,Diastolictxt,Cholesteroltxt,Gluecosetxt,Smokertxt,Alcoholictxt,Activetxt,ActiveLeveltxt,Heighttxt,Weighttxt,Goaltxt,Foodtxt;
...
//        boolean click = bundle.getBoolean("click");
        ...
        Smokertxt = findViewById(R.id.Smoker);
        ...
        Smokertxt.setAdapter(adapterItems);
